...
params = {
        ...
        "mrate_std" : 0.25, # mutation standard deviation as fraction of trait (gaussian)
        "number_of_jumps" : 100000, # number of jumps to simulate
        "init_pop_size" : 10000, # initial population size
        "number_of_ages" : 11, # number of ages
        "max_age" : 10., # maximal age
        "init_death" : 0.5, # initial death trait ['random'/float]
        "init_repr": 1., # initial reproduction trait ['random'/float]
